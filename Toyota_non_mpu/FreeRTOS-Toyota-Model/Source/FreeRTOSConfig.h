...
#include <stdint.h>
//extern uint32_t SystemCoreClock;            //removed 25/04/16
#ifndef __IASMARM__								//added 25/04/16
/* For SystemCoreClock */
#include "board.h"
#endif

/* Priorities to assign to tasks created by this demo. */
//#define configUART_COMMAND_CONSOLE_TASK_PRIORITY	    ( 2U ) //27.01.17
//#define configSPI_7_SEG_WRITE_TASK_PRIORITY			( 2U )
//#define configI2C_TASK_PRIORITY						    ( 3U ) //27.01.17
//#define configLEVEL_TASK_PRIORITY						( 3U ) //27.01.17

//28.01.17
#define configCONTROL_TASK_PRIORITY						( 4U )
#define configBRAKE_TASK_PRIORITY						( 3U )
#define configACCELERATION_TASK_PRIORITY				( 3U )
#define configINFOTAINMENT_TASK_PRIORITY				( 2U )
#define configDISPLAY_TASK_PRIORITY						( 2U )
...
#define configLEVEL_TASK_STACK_SIZE					( configMINIMAL_STACK_SIZE * 3)

//28.01.17
#define configCONTROL_TASK_STACK_SIZE					( configMINIMAL_STACK_SIZE * 4 )
#define configBRAKE_TASK_STACK_SIZE					( configMINIMAL_STACK_SIZE * 3)
#define configACCELERATION_TASK_STACK_SIZE					( configMINIMAL_STACK_SIZE * 3)
#define configINFOTAINMENT_TASK_STACK_SIZE					( configMINIMAL_STACK_SIZE * 3)
...
#define configUSE_STATS_FORMATTING_FUNCTIONS 	1   		//added 27/04/16
